...
let%expect_test "Attrs are NOT merged when \
  ...
  [%expect
    ...
    ("WARNING: not combining classes"
     (first (typeahead__inline_class_hash_4e4040875a))
     (second (typeahead__inline_class_hash_05f4fb403f)))
    <div>
      <input type="text"
             list="bonsai_path_replaced_in_test"
             placeholder="Select a value"
             value=""
             class="typeahead__inline_class_hash_replaced_in_test"
             #value=""
             @on_blur
             @on_change
             @on_focus
  ...
  [%expect
    ...
    <div>
      <input type="text"
             ...
             placeholder="Select a value"
             value=""
             class="typeahead__inline_class_hash_replaced_in_test typeahead__inline_class_hash_replaced_in_test"
             #value=""
             @on_blur
             @on_change
             @on_focus
